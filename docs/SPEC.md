...
- Export .pdf _(file)_
- _(separator)_
- Delete → Trash _(red trash, red text)_
...
- Right-click folder: New Note, New Folder, _(separator)_, Rename, Delete
...
- Has suggestions: ranked corrections → _(sep)_ → `Add "word" to dictionary` → _(sep)_ → lower-confidence
...
- **GitHub:** Repository (username/repo)_, Branch_, Personal Access Token*, Content Path*

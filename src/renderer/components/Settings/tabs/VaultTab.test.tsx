...
const info = {
  version: "1.0.0",
  tauri: "2.11.5",
  // The shape WKWebView actually reports, which is a WebKit build number and
  // not the Chromium-looking version that sat here while Electron shipped.
  webview: "21624.5.1.11.3",
